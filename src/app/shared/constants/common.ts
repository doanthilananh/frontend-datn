...
export const DELIVERY_INDEX_MAP = {
  [DELIVERY_INDEX.WAITING_TO_CONFIRM]: 0,
  [DELIVERY_INDEX.DELIVERING]: 1,
  [DELIVERY_INDEX.DELIVERED]: 2,
};
...
export const DELIVERY_STATE_MAP = {
  [DELIVERY_STATE.WAITING_TO_CONFIRM]: DELIVERY_INDEX.WAITING_TO_CONFIRM,
  [DELIVERY_STATE.DELIVERING]: DELIVERY_INDEX.DELIVERING,
  [DELIVERY_STATE.DELIVERED]: DELIVERY_INDEX.DELIVERED,
  [DELIVERY_STATE.CANCELED]: DELIVERY_INDEX.CANCELED,
};
